...
public class Showtime implements Serializable {
	...
	public Showtime(Date date, String name, ArrayList<Theater> theaters, int popularity, String category, double price,
			int rating) {
		this.date = date;
		this.name = name;
	 ...
	 * test harness code
	 * 
	 * public static void main(String[] args) { Showtime show1 = new Showtime();
	 * show1.set_date(new Date()); show1.set_movie("Endgame"); //test printing
	 * System.out.println(show1.toString()); //create some default theaters to store
	 * Theater theater1 = new Theater(1); Theater theater2 = new Theater(2); //add
	 * two theaters show1.addTheater(theater1); show1.addTheater(theater2);
	 * System.out.println("Showtime info:"); System.out.println(show1.toString()); }
	 */
}